...
public class UserController {
  ...
  //개인 회원가입
  @PostMapping("/signup")
  public ResponseEntity<UserResponse> signUp(@RequestBody @Valid SignUpForm signUpForm,
      Errors errors) {
    errorCheck(errors);
  ...
  @PreAuthorize("hasRole('USER')")
  public ResponseEntity<List<ReservationResponse>> searchReserve(
      @RequestHeader(name = "TOKEN") String token) {
  ...
  @PreAuthorize("hasRole('USER')")
  public ResponseEntity<String> cancelReserve(@RequestHeader(name = "TOKEN") String token,
